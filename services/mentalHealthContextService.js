class MentalHealthContextService {
  ...
  validateMentalHealthResponse(response) {
    ...
    // Check for missing empathy - expanded and more flexible
    const empathyIndicators = [
      'understand', 'hear', 'feel', 'sorry', 'difficult', 'challenging', 'valid', 
      'makes sense', 'sounds like', 'dealing with', 'going through', 'sharing', 'courage',
      'normal', 'common', 'okay', 'help', 'support', 'care', 'listen', 'here',
      'brave', 'strength', 'strong', 'tough', 'hard', 'struggle', 'experience',
      'acknowledge', 'recognize', 'appreciate', 'thank', 'glad', 'important'
    ];
    ...
    if (!hasEmpathy && response.length > 100) {
      issues.push('Response may lack empathetic language');
    }
